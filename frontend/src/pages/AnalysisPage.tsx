...
import { prof, tube1, tube2, tube3, tube4, tube5 } from '../assets';
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <img src={tube3} alt="Test tube 3" className={styles.tube3} />
        <img src={tube4} alt="Test tube 4" className={styles.tube4} />
        <img src={tube5} alt="Test tube 5" className={styles.tube5} />
