...
import { OrbitControls, useGLTF, useTexture} from '@react-three/drei'; // Import components correctly
        ...
        <section className={styles.section}>
            <div className={styles.textContainer}>
                ...
                <p className={styles.description}>
                    Improving your hair so you can get the best results for your hair. Also, you get the results
                    quickly.
                </p>
            ...
            <div className={styles.canvasContainer}>
                ...
                <Canvas>
                    {/* Use the correctly capitalized components from @react-three/drei */}
